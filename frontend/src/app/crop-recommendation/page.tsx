...
export default function CropRecommendation() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center bg-gradient-to-br from-green-50 to-green-200 p-6 relative">
      ...
      <div className="mt-6 bg-white p-6 rounded-xl shadow-lg w-full max-w-lg">
        <div className="grid grid-cols-2 gap-4">
          ...
          <input
            ...
            placeholder="Phosphorus Level (P)"
            className="border p-3 rounded-lg shadow-sm w-full"
          />
          <input
            type="text"
      ...
      <Link href="/">
        <button className="fixed bottom-6 right-6 bg-green-700 text-white px-4 py-3 rounded-full shadow-lg hover:bg-green-800 transition-all flex items-center space-x-2 text-sm font-medium border border-green-600">
          <span>Home</span>
        </button>
      </Link>
    </div>
